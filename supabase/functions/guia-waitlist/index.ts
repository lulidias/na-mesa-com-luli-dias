...
const EMAIL_HTML_EN = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Welcome — Luli Dias Restaurants &amp; Hotels</title>
</head>
        ...
        <tr>
          <td style="padding:48px 56px 40px;">
            ...
            <p style="font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#5A5045;line-height:1.8;margin:0 0 20px;">
              The guide isn't live yet — I'm putting the finishing touches on it. But it'll happen soon, and you'll be one of the first to know.
            </p>

            <p style="font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#5A5045;line-height:1.8;margin:0 0 20px;">
              What you'll find is a personal guide to restaurants and hotels across <strong style="color:#1A1A1A;font-weight:600;">37 countries</strong>. Every place visited, every bill paid — no invitations, no press trips, no complimentary dinners. Only the places I genuinely think are worth it.
            </p>

            <p style="font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#5A5045;line-height:1.8;margin:0 0 40px;">
              I'll let you know at launch. I really hope you enjoy it!
            </p>
            ...
            <p style="font-family:Georgia,'Times New Roman',serif;font-size:15px;color:#8A7E72;font-style:italic;margin:0 0 4px;">Best,</p>
        ...
        <tr>
          <td align="center" style="padding:18px 48px;background:#F7F3EE;border-top:1px solid #E8E0D5;">
            <p style="font-family:Arial,Helvetica,sans-serif;font-size:10px;color:#B0A090;letter-spacing:1px;margin:0;">
              You received this email because you signed up at lulidias.com
            </p>
          </td>
        </tr>
...
Deno.serve(async (req) => {
  ...
  let email: string, lang: string;
  try {
    const body = await req.json();
    email = (body?.email ?? "").trim().toLowerCase();
    lang = (body?.lang ?? "pt") === "en" ? "en" : "pt";
  } catch {
